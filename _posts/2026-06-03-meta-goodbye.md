...
So, what next? The obligatory badge-and-sticker-laden laptop pictures are below, but I've been heads down building apps now that I have more time. In the past two weeks I've used everything from OpenClaw to Hermes to Claude Code and Codex, played with open-source models (Qwen, Gemma 3), given Anthropic nearly ~1k of money I no longer earn, made a very small contribution to the [OpenClaw repo](https://github.com/openclaw/openclaw/commit/6727985365), and even tried my hand at a little bit of fine-tuning. The result: my first app shipped to the Apple App Store in years ([TokenCounter](https://apps.apple.com/app/id6772613833)), with a game on the way. Mostly I've been trying to understand how far I can take these models and I'm very, very excited by what I see. The lines we've traditionally drawn between product functions (PM, Eng, Design) are blurring, which means everyone can bring their ideas to the table with far more fidelity. The more I dig, the more convinced I am that these divisions will be about what we "choose" to do, not what we "can" do.

With that said, I'm itching for my next adventure. If you're looking for someone who:

1. is an AI-obsessed product builder who was an engineer in a past life (11 years)
2. is comfortable building and running teams on 0-to-1 products
3. loves guiding cross-functional teams — eng, design, data, research, even bots — with whatever they need: requirements, roadmaps, or brainstorms
4. prefers demos over memos
5. lives deep in prompt vs. context engineering vs. agent harnesses
6. has been active on GitHub since 2013 ([github.com/arunjeetsingh](https://github.com/arunjeetsingh))
7. is comfortable serving end users, enterprises, and developers alike

then I might be a fit. Give me a shout and help me figure out what's next.

*#opentowork #humangenerated #AICurated*

<figure class="post-figure">
  <img src="{{ '/assets/img/posts/meta-goodbye-laptop.jpg' | relative_url }}" alt="A laptop lid covered in stickers and badges collected over the years at Meta, with a clipped 'Arun Singh' ID badge resting on top" loading="lazy">
  <figcaption>The obligatory badge-and-sticker-laden laptop.</figcaption>
</figure>
